...
let previewerHover = app.ui.settings.getSettingValue("PowerLoader.Previewer.PreviewerHover", "Move to Other Side");
...
app.registerExtension({
    ...
    setup() {
        ...
        function updateStyle() {
            let pos = previewePos;
            const sidebarPos = app.ui.settings.getSettingValue("Comfy.Sidebar.Location", "left");
            const sidebarStyle = app.ui.settings.getSettingValue("Comfy.Sidebar.Style", "connected");
